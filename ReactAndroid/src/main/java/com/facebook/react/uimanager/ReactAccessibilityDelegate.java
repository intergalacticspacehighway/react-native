...
public class ReactAccessibilityDelegate extends AccessibilityDelegateCompat {
  ...
  public static void setAccessibilityCollectionInfo(View host, AccessibilityNodeInfoCompat info) {
    final ReadableMap accessibilityCollectionInfo =
      (ReadableMap) host.getTag(R.id.accessibility_collection_info);

    Log.d("collectionInfo"," "+accessibilityCollectionInfo);
